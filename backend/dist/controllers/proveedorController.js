...
export const getProveedores = async (req, res) => {
    try {
        ...
        let condition = proveedorsEncontrados.length === 0;
...
export const getProveedoresID = async (req, res) => {
    try {
        ...
        let condition = proveedorEncontrado === null;
 ...
 */
export const deleteProveedoresID = async (req, res) => {
    try {
        const proveedorEliminado = await proveedorModel.findOneAndDelete({ id_: req.params.id });
        let condition = proveedorEliminado === null;
